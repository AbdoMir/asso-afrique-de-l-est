...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 font-semibold rounded-full transition-all duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none',
  {
    variants: {
      variant: {
        primary:
        ...
        outline:
          'bg-transparent border-2 border-warm-900 text-warm-900 hover:bg-warm-900 hover:text-white focus-visible:outline-primary-500',
        ghost:
        ...
        accent:
          'bg-accent-500 text-warm-900 hover:bg-accent-600 shadow-sm hover:-translate-y-0.5',
      },
      size: {
